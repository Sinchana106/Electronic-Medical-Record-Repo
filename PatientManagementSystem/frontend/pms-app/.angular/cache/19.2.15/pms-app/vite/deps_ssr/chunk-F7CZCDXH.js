...
import {
  ...
  ScrollingModule,
  ViewportRuler
} from "./chunk-6IZGKUY4.js";
import {
  supportsScrollBehavior
} from "./chunk-XW6SDNL2.js";
import {
  FormGroupDirective,
  NgControl,
  NgForm,
...
var MatSelect = class _MatSelect {
  ...
  optionSelectionChanges = (0, import_rxjs3.defer)(() => {
    ...
    if (options) {
      return options.changes.pipe((0, import_operators3.startWith)(options), (0, import_operators3.switchMap)(() => (0, import_rxjs3.merge)(...options.map((option) => option.onSelectionChange))));
    }
  ...
  _resetOptions() {
    ...
    (0, import_rxjs3.merge)(...this.options.map((option) => option._stateChanges)).pipe((0, import_operators3.takeUntil)(changedOrDestroyed)).subscribe(() => {
      this._changeDetectorRef.detectChanges();
      this.stateChanges.next();
    });
  }
...
//# sourceMappingURL=chunk-F7CZCDXH.js.map
